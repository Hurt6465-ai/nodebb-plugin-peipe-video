...
<link rel="stylesheet" href="{relative_path}/plugins/nodebb-plugin-peipe-video/static/video-app.css?v=18">
...
<script src="{relative_path}/plugins/nodebb-plugin-peipe-video/static/video-app.js?v=18"></script>
