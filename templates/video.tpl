...
<link rel="stylesheet" href="{relative_path}/plugins/nodebb-plugin-peipe-video/static/video-app.css?v=13">
<script>
...
<script src="{relative_path}/plugins/nodebb-plugin-peipe-video/static/video-app.js?v=13"></script>
