...
.pv-init-loading{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:#000;color:rgba(255,255,255,.82);font-weight:800;font-size:15px;}
</style>
<div id="peipe-video-app" class="pv-root" data-cid="{cid}" data-version="v13-full-from-new-js">
  <div class="pv-init-loading">发现加载中...</div>
</div>
<link rel="stylesheet" href="/plugins/nodebb-plugin-peipe-video/static/video-app-v13.css">
<script>
...
<script src="/plugins/nodebb-plugin-peipe-video/static/video-app-v13.js"></script>
