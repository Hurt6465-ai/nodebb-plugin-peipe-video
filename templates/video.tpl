...
<link rel="stylesheet" href="{relative_path}/plugins/nodebb-plugin-peipe-video/static/video-app.css?v=6">
<script>
...
<script src="{relative_path}/plugins/nodebb-plugin-peipe-video/static/video-app.js?v=6"></script>
